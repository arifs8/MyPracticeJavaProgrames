...
public class MergeTwoSortedOrUnsortedArraysToSingleSorted {
	...
	public static void main(String[] args) {
        ...
        int[] mergeedArray = mergeArraysAndRemoveDuplicates(arrayA, arrayB);
        ...
        System.out.println(Arrays.toString(mergeedArray));
